...
class MetricsPublisher
{
  public:
    ...
    void setCodecSelectionFlags(bool auto_codec_requested, bool hw_selected, bool sw_fallback_applied);
    ...
    void publishEvent(const std::string& severity, const std::string& code, const std::string& message);

  private:
    ros2_gst_video_bridge_msgs::msg::RuntimeStatus buildStatusSnapshot(uint64_t now_ns, double elapsed_s);

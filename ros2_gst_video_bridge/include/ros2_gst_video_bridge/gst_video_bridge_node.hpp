...
private:
  enum class RuntimeState : uint8_t { Connecting, Streaming, Degraded, Reconnecting, Failed };
  ...
  void publishRuntimeEvent(const std::string& severity, const std::string& code,
  ...
  rclcpp::Service<ros2_gst_video_bridge_msgs::srv::SetStreamingProfile>::SharedPtr
      set_profile_service_;
